  ...
  return (
    <div className="">
      <div className="container mx-auto px-4 md:px-10">
        ...
        <div className="py-20">
          <h2 className="font-bold text-2xl md:text-5xl md:leading-14 inline-block bg-blue/20 px-8 py-8 rounded-lg relative text-darkBlue">Inclusive Sign Langauge Two Way Communication Platform for Nepali Sign Language <Asterisk size={90} className="animate-slowspin text-blue  absolute -top-10 -left-10" /></h2>
          <div className="pt-8">
            <h3 className="text-2xl md:text-3xl font-semibold flex items-center gap-3"><FaDiamond className="text-lg text-blue" />Problem</h3>
          ...
          <div className="pt-8">
            <h3 className="text-2xl md:text-3xl font-semibold flex items-center gap-3 text-darkBlue"><FaDiamond className="text-lg text-blue" /> Research Aim</h3>
          ...
          <div className="pt-8">
            <h3 className="text-2xl text-darkBlue md:text-3xl font-semibold flex items-center gap-3"><FaDiamond className="text-lg text-blue" />Current Stage of the research</h3>
          ...
          <div className="pt-8">
            <h3 className="text-2xl text-darkBlue md:text-3xl font-semibold flex items-center gap-3"><FaDiamond className="text-lg text-blue" />Outcomes so far</h3>
            <ul className="text-zinc-700 pt-4 space-y-2 list-decimal list-inside">
              <li>We published a paper titled &quot;Finger Spelling Gesture Recognition for Nepali Sign Language Using Hybrid Classical Quantum Deep Learning Model&quot; at <Link to={"https://ictceel.khwopaconference.com/"} className="text-blue font-semibold underline" target="_blank">ICE-CEEL 2023</Link>.</li>

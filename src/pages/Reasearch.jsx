  ...
  return (
    <div className="">
      <div className="container mx-auto px-4 md:px-10">
        ...
        <div className="py-20">
          <h2 className="font-bold text-3xl md:text-5xl leading-14 inline-block bg-[#E0F2FE] px-8 py-8 rounded-lg relative">Inclusive Sign Langauge Two Way Communication Platform for Nepali Sign Language <Asterisk size={90} className="animate-slowspin text-primary  absolute -top-10 -left-10" /></h2>
          <div className="pt-8">
            <h3 className="text-3xl font-semibold flex items-center gap-3"><FaDiamond className="text-lg text-primary" />Problem</h3>
          ...
          <div className="pt-8">
            <h3 className="text-3xl font-semibold flex items-center gap-3"><FaDiamond className="text-lg text-primary" /> Research Aim</h3>
          ...
          <div className="pt-8">
            <h3 className="text-3xl font-semibold flex items-center gap-3"><FaDiamond className="text-lg text-primary" />Current Stage of the research</h3>
          ...
          <div className="pt-8">
            <h3 className="text-3xl font-semibold flex items-center gap-3"><FaDiamond className="text-lg text-primary" />Outcomes so far</h3>

...
const Mission = () => {
  return (
    <div className="">
      <div className="container mx-auto px-10 grid grid-cols-12 py-10 gap-14">
        <div className="col-span-6 relative mt-14">
          <img src={img1} alt="" className="w-[90%]" />
          <div className="absolute size-82 top-85 right-0 border-[12px] rounded-2xl overflow-hidden border-white">

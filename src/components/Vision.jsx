    ...
    <div className="grid grid-cols-1 md:grid-cols-12 py-20 gap-10">
      <div className="md:col-span-6">
        <div className="relative">
          <h3 className="font-semibold text-2xl uppercase text-blue pt-4 md:pt-8 flex items-center"><Asterisk size={28} className="animate-slowspin" />Our Vision</h3>
          <p className="font-semibold text-7xl md:text-8xl uppercase opacity-15 text-blue absolute top-0">Vision</p>
        </div>
      ...
      <div className="md:col-span-6 relative hidden md:block">
        <div className="absolute size-42 border-[12px] rounded-2xl border-[#E0F2FE] -mt-5 ml-10 overflow-hidden z-20">
        ...
        <div className="absolute h-56 -mb-8 bottom-0 border-[12px] rounded-2xl border-[#E0F2FE]  overflow-hidden">

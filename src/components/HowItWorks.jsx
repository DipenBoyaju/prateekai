    ...
    <div className="container mx-auto px-4 md:px-10 py-20">
      <div className="grid md:grid-cols-12 gap-10">
        <div className="col-span-6">
          <h3 className="font-semibold text-base text-primary flex items-center"><Asterisk size={28} className="animate-slowspin" />Understanding the Process</h3>
          <h1 className='text-6xl pt-3 font-bold text-zinc-900'>How It Works</h1>
          <div className="space-y-6 mt-4">
            <div className="bg-white p-6 rounded-lg shadow-sm flex items-center gap-4">
              <Camera size={48} className="text-primary" />
              <div className="">
                <h3 className="text-xl font-semibold mb-2 text-zinc-900">1. Enable Camera</h3>
                <p className="text-gray-600">Allow access to your webcam for real-time sign detection.</p>
              </div>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm flex items-center gap-4">
              <Hand size={48} className="text-primary" />
              <div className="">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm flex items-center gap-4">
              <MonitorStop size={48} className="text-primary" />
              <div className="">
                <h3 className="text-xl font-semibold mb-2">3. Get Translation</h3>
